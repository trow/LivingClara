...
INTERJECT BANOMEN 484 YF_ClaraMakesItBetter /*I... I lost everything I worked towards to perform my duty for my family... at his insistence... and he disowns me! He disowns me!*/
	...
	DO ~SetGlobal("YF_ClaraAnomenLove","GLOBAL",46) SetGlobalTimer("YF_AnomenClaraCorTimer","GLOBAL",FOUR_DAYS) SetGlobal("YF_ACGonnaStabCor","GLOBAL",1) SetGlobal("KickedOut","LOCALS",1) ChangeAIScript("",DEFAULT) SetLeavePartyDialogueFile() LeaveParty() EscapeAreaMove("AR1001",665,260,NNW) SetGlobal("YF_AnomenIsAntipaladin","GLOBAL",0) SetGlobal("YF_ClaraWihtAnomenLeave","LOCALS",0)~
	== YF_CLARJ @259 /*And I will be by your side, my love, no matter what occurs.*/
	DO ~AddJournalEntry(@999,USER) SetGlobal("KickedOut","LOCALS",1) ChangeAIScript("",DEFAULT) LeaveParty() EscapeAreaMove("AR1001",620,280,NNW) SetGlobal("YF_ClaraWihtAnomenLeave","LOCALS",1)~ /*Journal Entry: Anomen received a letter from his father that distressed him greatly. It seems the true killers of his sister Moira were discovered and his father has disowned him for killing Saerk instead. A cruel twist of fate given all that he has paid. 
