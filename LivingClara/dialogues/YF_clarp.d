...
APPEND YF_clarp IF ~Global("KickedOut","LOCALS",0) !Global("YF_LordAndLadyDelryn","GLOBAL",5) !Global("YF_LadyDelryn","GLOBAL",1) !Global("YF_ClaraWihtAnomenLeave","LOCALS",1)~ THEN YF_CP1
	SAY @0 /*So I guess this is it then?*/
		...
		+ ~!GlobalGT("YF_ClaraAnomenLove","GLOBAL",23) Global("YF_RenalClara","GLOBAL",0) !Global("YF_RenalOHHFAK","GLOBAL",2) !Global("B!Alternatives","GLOBAL",6) !Global("D0AranHostile","GLOBAL",1) !GlobalGT("WorkingforBodhi","GLOBAL",0) !Global("AttackedThieves","GLOBAL",1) !Dead("aran")~ + @2 /*Yes, we should go our separate ways.*/ GOTO YF_CP2
	...
	SAY @3 /*Okay, I'll go to the bridge district then. You'll probably find me at the Five Flagons Inn.*/
		...
		+~!Global("PLAYHOUSE","GLOBAL",1)~+ @5 /*Okay, I'll find you there.*/ DO ~SetGlobal("KickedOut","LOCALS",1) ChangeAIScript("",DEFAULT) SetGlobal("YF_ClaraWaiting","GLOBAL",0) EscapeAreaMove("AR0509",470,404,E)~ EXIT
		+~Global("PLAYHOUSE","GLOBAL",1)~+ @5 /*Okay, I'll find you there.*/ DO ~SetGlobal("KickedOut","LOCALS",1) ChangeAIScript("",DEFAULT) SetGlobal("YF_ClaraWaiting","GLOBAL",0) EscapeAreaMove("AR0522",470,404,E)~ EXIT
	END
	
	IF ~~ THEN YF_CP3
	SAY @6 /*Here? Fine. But you have one day and then I'm leaving. I'll be safer somewhere else.*/ 
	IF ~~ THEN DO ~SetGlobal("YF_ClaraWaiting","GLOBAL",1) SetGlobal("KickedOut","LOCALS",1) ChangeAIScript("",DEFAULT)~ EXIT
	END
	...
	+ ~Gender(Player1,FEMALE)~ + @71 /*Sorry, I don't need you anymore. Goodbye.*/ GOTO YF_CP6
	+ ~Gender(Player1,MALE)~ + @71 /*Sorry, I don't need you anymore. Goodbye.*/ GOTO YF_CP8
	...
	SAY @73 /*Please, I won't last three days! And I can't go home, I can't! Let me stay with you. I won't get in the way. I'll do anything, I promise. I mean if you were a man, I know I could convince you I was worthwhile, but even so I can wash your clothes, cook your food, and clean your weapons and armor!*/
		...
		++ @75 /*Why let me being a woman stop you? You can still share my bed. Do it well enough and I might decide to keep you around.*/ GOTO YF_CP7
		++ @76 /*Nope, sorry, goodbye.*/ GOTO YF_CP2
	END
...
CHAIN YF_clarp YF_CPA
@87 /*All right, I'll go to the Copper Coronet.*/
== YF_clarp IF ~IfValidForPartyDialogue("Anomen")~ THEN @88 /*Don't wait too long to visit, Anomen.*/
...
== YF_clarp IF ~IfValidForPartyDialogue("Anomen")~ THEN @90 /*You are sweet to worry, but I can take care of myself.*/
== YF_clarp IF ~!IfValidForPartyDialogue("Anomen")~ THEN @91 /*I can't let my darling Anomen forget about me now.*/
== YF_clarp @92 /*See you later, <CHARNAME>.*/
END
	++ @4 /*No, I need you to stay right here. I'll be back soon.*/ DO ~SetGlobal("YF_ClaraCC","GLOBAL",1)~ GOTO YF_CP3
	++ @5 /*Okay, I'll find you there.*/ DO ~SetGlobal("KickedOut","LOCALS",1) ChangeAIScript("",DEFAULT) SetGlobal("YF_ClaraWaiting","GLOBAL",0) EscapeAreaMove("AR0406",1478,1644,SE)~ 
EXIT


APPEND YF_clarp IF WEIGHT #-1 ~Global("KickedOut","LOCALS",1) Global("YF_ClaraWaiting","GLOBAL",2)~ THEN YF_CPW1
	SAY @8 /*I... hate... waiting. Can I come back yet?*/ 
		++ @9 /*No, not yet. Stay here a little longer.*/ EXIT
		++ @10 /*Yes. Sorry to make you wait.*/ DO ~SetGlobal("KickedOut","LOCALS",0) SetGlobal("YF_ClaraWaiting","GLOBAL",0) JoinParty()~ EXIT
	END
END


//If Clara is in the Five Flagons, the first time. (FFCUST09) should be Sterk.
APPEND YF_clarp IF ~Global("KickedOut","LOCALS",1) !Dead("sterk") Global("YF_clarajoining","GLOBAL",0) Global("YF_ClaraWaiting","GLOBAL",0) OR(2) AreaCheck("AR0509") AreaCheck("AR0522")~ THEN YF_Clara0Join1
	SAY @11 /*Good timing, <CHARNAME>, we were just speaking about you. I was telling Lord Sterk how you saved me from Hexxat and Dragomir.*/
		++ @12 /*Anyone in my position would've done the same.*/ DO ~SetGlobal("YF_clarajoining","GLOBAL",1)~ EXTERN FFCUST09 YF_Clara0Join2
		++ @13 /*It's all part of being a hero.*/ DO ~SetGlobal("YF_clarajoining","GLOBAL",1)~ EXTERN FFCUST09 YF_Clara0Join2
		++ @14 /*And what a waste that was. They didn't even have any gold.*/ DO ~SetGlobal("YF_clarajoining","GLOBAL",1)~ EXTERN FFCUST09 YF_Clara0Join2
	END
END
	
CHAIN FFCUST09 YF_Clara0Join2
	...
	== YF_clarp @16 /*Yes, I still cry at night sometimes thinking about them. However, as my father always told me, a young woman must be strong. I will persevere.*/
	...
	== YF_clarp @19 /*Hi <CHARNAME>! What are you doing here?*/
	END
		++ @20 /*Well, 'Caroline', I just wanted to say hello and see how you were.*/ EXTERN YF_clarp YF_Clara0Join3
		++ @21 /*And now you've shifted your accent again. What game are you playing? Hexxat and Dragomir didn't kill your parents, did they?*/ EXTERN YF_clarp YF_Clara0Join4
		++ @22 /*I want you to come with me.*/ EXTERN YF_clarp YF_Clara0Join6
		++ @23 /*I want to get to know you a little better. Is there somewhere private we could go?*/ EXTERN YF_clarp YF_Clara0Join7

APPEND YF_clarp IF ~~ THEN YF_Clara0Join3
	...
	= @28 /*Are you just saying hi or did you want something?*/
		++ @29 /*I'm just saying hi. How are you?*/ GOTO YF_Clara0Join3
		++ @30 /*But that's not what actually happened.*/ GOTO YF_Clara0Join5
		++ @22 /*I want you to come with me.*/ GOTO YF_Clara0Join6
		++ @23 /*I want to get to know you a little better. Is there somewhere private we could go?*/ GOTO YF_Clara0Join7
	END
	
	IF ~~ THEN YF_Clara0Join5
	...
	= @33 /*But I'm rambling. Did you want something?*/
		++ @34 /*No, I'm just saying hi. How are you?*/ GOTO YF_Clara0Join3
		++ @35 /*Yes, I want you to come with me.*/ GOTO YF_Clara0Join6
		++ @23 /*I want to get to know you a little better. Is there somewhere private we could go?*/ GOTO YF_Clara0Join7
	END
	
	IF ~~ THEN YF_Clara0Join6
	...
	= @37 /*No thanks. I like breathing... and living... and most of all I like not dying.*/
		++ @38 /*Anything I can do to change your mind?*/ GOTO YF_Clara0Join8
		++ @39 /*Oh, well then I guess I'll see you around.*/ GOTO YF_Clara0Join10
	END
	
	IF ~~ THEN YF_Clara0Join7
	...
	IF ~~ THEN YF_Clara0Join8
	SAY @42 /*Sure. My price is 1,000 gold.*/
		+ ~PartyGoldGT(999) ~+ @43 /*Okay.*/ DO ~ActionOverride("YF_clara",TakePartyGold(1000)) ActionOverride("YF_clara",DestroyGold(1000))~ GOTO YF_Clara0Join9
		+ ~CheckStatGT(Player1,13,CHR) PartyGoldGT(499)~ + @44 /*How about 500?*/ DO ~ActionOverride("YF_clara",TakePartyGold(500)) ActionOverride("YF_clara",DestroyGold(500))~ GOTO YF_Clara0Join9
		++ @45 /*Nah, you're not worth that. See you around.*/ GOTO YF_Clara0Join10
		++ @46 /*Sorry, I don't have that kind of cash.*/ GOTO YF_Clara0Join10
	END 
END
	
CHAIN YF_clarp YF_Clara0Join9
	...
	DO ~ActionOverride("YF_clara",JoinParty())~
EXIT
	
APPEND YF_clarp IF ~~ THEN YF_Clara0Join10
...
APPEND YF_clarp IF ~Global("KickedOut","LOCALS",1) !Dead("sterk") Global("YF_clarajoining","GLOBAL",1) Global("YF_ClaraWaiting","GLOBAL",0) OR(2) AreaCheck("AR0509") AreaCheck("AR0522")~ THEN YF_Clara0Join1
...
APPEND YF_clarp IF ~Global("KickedOut","LOCALS",1) !Global("YF_LordAndLadyDelryn","GLOBAL",5) !Global("YF_LadyDelryn","GLOBAL",1) !Global("YF_ClaraWihtAnomenLeave","LOCALS",1)~ THEN YF_Clara2Join1
	SAY @54 /*Hi, <CHARNAME>, how can I help you? Do you need something?*/
		...
		++ @23 /*I want to get to know you a little better. Is there somewhere private we could go?*/ GOTO YF_Clara2Join4
	END
	
	IF ~~ THEN YF_Clara2Join2
	...
	SAY @56 /*Join you? You want me to give up my comfy and profitable life to go seek death with you? To explore slimy, trap-filled dungeons crawling with undead and battle powerful monsters with the fate of the world hanging in the balance? My price is 1000 gold.*/
		+~PartyGoldGT(999)~+ @43 /*Okay.*/ DO ~ActionOverride("YF_clara",TakePartyGold(1000)) ActionOverride("YF_clara",DestroyGold(1000))~ GOTO YF_Clara2Join5
		+~CheckStatGT(Player1,13,CHR) PartyGoldGT(499)~+ @44 /*How about 500?*/ DO ~ActionOverride("YF_clara",TakePartyGold(500)) ActionOverride("YF_clara",DestroyGold(500))~ GOTO YF_Clara2Join5
		++ @45 /*Nah, you're not worth that. See you around.*/ GOTO YF_Clara2Join6
		++ @46 /*Sorry, I don't have that kind of cash.*/ GOTO YF_Clara2Join6
	END 
		
	IF ~~ THEN YF_Clara2Join4
	...
	IF ~~ THEN YF_Clara2Join5
	SAY @59 /*Yaay! Okay, let me just get my things.*/
	IF ~~ THEN 	DO ~SetGlobal("KickedOut","LOCALS",0) JoinParty()~ EXIT
	END
	
	IF ~~ THEN YF_Clara2Join6
	SAY @51 /*Fine with me. Feel free to come by and say hello again in the future. If you manage not to die...*/
	IF ~~ THEN EXIT
	END
END

//short-term P file adjustments in YF_ClaraAnomen file
//New default joining options after marries Cor (& he's alive) or Anomen are in YF_ClaraAnomen. That was just easier.

//New Kicked Out Dialogue if Married Anomen
CHAIN IF ~Global("KickedOut","LOCALS",0) Global("YF_LordAndLadyDelryn","GLOBAL",5) !Global("YF_LadyDelryn","GLOBAL",1)~ THEN YF_clarp YF_LadyDelrynP
...
END
		++ @4 /*No, I need you to stay right here. I'll be back soon.*/ GOTO YF_CP3
		++ @5 /*Okay, I'll find you there.*/ DO ~SetGlobal("KickedOut","LOCALS",1) ChangeAIScript("",DEFAULT) SetGlobal("YF_ClaraWaiting","GLOBAL",0) EscapeAreaMove("AR1001",652,209,SW)~ EXIT

CHAIN YF_clarp YF_LadyDelrynP2
...
CHAIN YF_clarp YF_LadyDelrynP3
...
CHAIN IF ~Global("KickedOut","LOCALS",0) Global("YF_LadyDelryn","GLOBAL",1) !Global("YF_LordAndLadyDelryn","GLOBAL",5)~ THEN YF_clarp YF_LadyClaraP
@60 /*Do you really want me to leave?*/
END
		++ @1 /*No, I want you to stay.*/ DO ~JoinParty()~ EXIT
...
CHAIN IF ~Global("KickedOut","LOCALS",1)  Dead("Cor") Global("YF_ClaraAndCor","GLOBAL",3) Global("YF_LadyDelryn","GLOBAL",1)~ THEN YF_clarp YF_WidowDelryn
@65 /*Hello, <CHARNAME>, you are always welcome in the house of Lady Delryn. What can I do for you?*/
END
	+ ~!Dead("saerk")~ + @66 /*Nothing, I just stopped by to see how you are.*/ + YF_WidowDelryn1
	+ ~Dead("saerk")~ + @66 + YF_WidowDelryn2
	++ @67 /*You could travel with me.*/ + YF_WidowDelryn3
	
CHAIN YF_clarp YF_WidowDelryn1
...
END
	+ ~PartyGoldGT(999)~ + @83 /*How about 1000 gold?*/ + YF_WidowDelryn4A
	+ ~CheckStatGT(Player1,13,CHR) PartyGoldGT(499)~ + @84 /*How about 500 gold?*/ + YF_WidowDelryn4B
	++ @85 /*Nothing, I guess.*/ EXIT
	
CHAIN YF_clarp YF_WidowDelryn4A
@86 /*Deal! Let me just grab my things.*/
DO ~ActionOverride("YF_clara",TakePartyGold(1000)) ActionOverride("YF_clara",DestroyGold(1000)) SetGlobal("KickedOut","LOCALS",0) JoinParty()~
EXIT

CHAIN YF_clarp YF_WidowDelryn4B
@86 /*Deal! Let me just grab my things.*/
DO ~ActionOverride("YF_clara",TakePartyGold(500)) ActionOverride("YF_clara",DestroyGold(500)) SetGlobal("KickedOut","LOCALS",0) JoinParty()~
EXIT

//Dialogue to change kit.
CHAIN YF_clarp YF_ClaraKitChange1
...
CHAIN YF_clarp YF_ClaraKitChange2
	@114 /**/
...
CHAIN YF_clarp YF_ClaraKitChange3
	@114 /**/
...
CHAIN YF_clarp YF_ClaraKitChange4 
	@114 /**/
...
CHAIN YF_clarp YF_ClaraKitChange5
	@114 /**/
...
CHAIN YF_clarp YF_ClaraKitChange6
	@114 /**/
