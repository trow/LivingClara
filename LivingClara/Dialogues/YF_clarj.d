...
//Beginning talk moved to YF_clara

//If you go see Renal Bloodscalp with Clara.
CHAIN IF WEIGHT #-1 ~NumTimesTalkedToGT(0) Global("YF_ClaraRenal","GLOBAL",1) InParty("YF_Clara") Global("YF_RenalClara","GLOBAL",1) !Global("YF_RenalOHHFAK","GLOBAL",2)~ THEN RENAL YF_RenalClara1
...
//Clara-Imoen Talk
CHAIN IF WEIGHT #-1 ~Global("YF_CITalk","GLOBAL",1)~ THEN YF_clarj YF_ClaraImoen
@6 /*Hello.*/
DO ~SetGlobal("YF_CITalk","GLOBAL",2)~
...
== YF_clarj @9 /*I have a way of fading from memory when I want to; even the people who are looking for me often forget that I am there.*/
...
== YF_clarj @16 /*My family was killed, a vampire killed me, and then <CHARNAME> saved me, so now I follow <PRO_HESHE> around and try not to die horribly.*/
...
CHAIN IF WEIGHT #-1 ~Global("YF_clarapoisontalk","GLOBAL",1)~ THEN YF_clarj YF_ClaraViconiaPoison
@20 /*Home sweet home. The smell of this bar always brings me back.*/
DO ~SetGlobal("YF_clarapoisontalk","GLOBAL",2)~
...
== YF_clarj @26 /*All right, then. Watch me work. You won't see a thing.*/
...
== YF_clarj @31 /*Now, where to?*/
== VICONIJ @32 /*Now we wait and watch them die.*/
== YF_clarj @33 /*So what do we do while we wait?*/
= @34 /*I know! Let's play a game! See it's called the Lying Game and...*/
== VICONIJ @35 /*I do not play games.*/
== YF_clarj @36 /*But it's fun. See, first you...*/
== VICONIJ @37 /*Shh.*/
== YF_clarj @38 /*You're no fun at all.*/
...
== YF_clarj @42 /*Just another couple of drunks who couldn't hold their liquor. Can we go now?*/
