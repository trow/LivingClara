...
CHAIN IF ~InParty("Valygar") InMyArea("Valygar") IfValidForPartyDialog("Valygar") IfValidForPartyDialog("YF_Clara") AreaType(FOREST) Global("YF_BCLARAVALYG","GLOBAL",0)~ THEN BYF_Clar YF_ClaraValygar1
@344 /*Valygar, how do you move so quietly?*/
DO ~SetGlobal("YF_BCLARAVALYG","GLOBAL",1)~
== BVALYGA @345 /*That is a strange question coming from you. I am not the thief between us.*/
== BYF_Clar @346 /*Well, yeah, I'm great at hiding in a city. There are people and alleyways and crates to duck behind. But how do you manage to keep to the shadows here? It's all bugs and open space and branches that snap beneath your feet.*/
...
== BYF_Clar @349 /*I've never thought about it that way. Can you show me? I want to move the way you do.*/
...
CHAIN IF ~InParty("Edwin") IfValidForPartyDialog("Edwin") Gender("Edwin",FEMALE) InMyArea("Edwin") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAEDWINA","GLOBAL",0)~ THEN BYF_Clar YF_ClaraEdwina1
...
DO ~SetGlobal("YF_BCLARAEDWINA","GLOBAL",1) ChangeStat("YF_Clara",SAVEVSSPELL,-1,ADD)~
== BYF_Clar @393 /*Really? Not even a way to fix your little gender issue? I have a friend who dabbles in certain rare items and when I told them about your mishap, they offered me this belt. The Girdle of Femininity/Masculinity I think they called it... And when I put it on...*/
= @394 /*Ta-da! Clarence at your service.*/
== BEDWIN @395 /*What? You found it? Give me that belt this instant!*/
== BYF_Clar @396 /*I don't know. Maybe I should keep it. This girdle could be all kinds of fun and you've been awfully rude...*/
...
== BYF_Clar @398 /*You could, but you won't. <CHARNAME> wouldn't like it and you won't risk losing <PRO_HISHER> protection. I know your type and for all your pride, self-preservation will always be your number one priority.*/
== BEDWIN @399 /*(Perhaps she is not as stupid as I'd thought.) Then what is your price? I assume that you want something.*/
== BYF_Clar @400 /*Nothing much. Just ask me nicely. A "please" would be preferred.*/
...
== BYF_Clar @403 /*Hah! I could hear your teeth grinding all the way over here. But I guess that's good enough. Here. Take it.*/
DO ~GiveItemCreate("YF_BELTC","Edwin",0,0,0)~
...
== BYF_Clar @406 /*Well... I may have paid a hedge witch to enchant the item so only I could use it, but surely such a great and powerful wizard as yourself can break the spell?*/
== BEDWIN @407 /*You... YOU! YOU UNWASHED TREACHEROUS IMBECILIC CRETINOUS...*/
== BYF_Clar @408 /*Worth. Every. Penny.*/
EXIT

//1st Jan Banter
CHAIN IF ~InParty("Jan") InMyArea("Jan") IfValidForPartyDialog("Jan") IfValidForPartyDialog("YF_Clara") Global("YF_BClaraJan","GLOBAL",0)~ THEN BYF_Clar YF_clarjan1
@1 /*Jan, could you help me?*/
DO ~SetGlobal("YF_BClaraJan","GLOBAL",1)~
== BJAN @2 /*Of course, my dear. What seems to be the problem?*/
== BYF_Clar @3 /*Well, you are so amazing with your magic and your skills... and I am supposed to be acting as a thief, disarming traps, opening locks, and the like, and...*/
...
== BYF_Clar @6 /*I will try to avoid that. But I noticed you have all this special clothing and gadgets to help you and I was wondering...*/
== BJAN @7 /*There you go again; if you keep doing this, I will make you continue our conversation from farther away.*/
== BYF_Clar @8 /*I want all your stuff! Can I have it? Please?*/
...
CHAIN IF WEIGHT #1 ~InParty("YF_Clara") InMyArea("YF_Clara") IfValidForPartyDialog("Nalia") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARANALIA","GLOBAL",0)~ THEN BNALIA YF_ClaraNalia1
...
DO ~SetGlobal("YF_BCLARANALIA","GLOBAL",1)~
== BYF_Clar @277 /*You doubt MY lineage? I am Lady Caroline Aurora Lucia Rosena Silvershield and my blood is as blue as any that flows within your veins. You're the one who sneaks out of your castle to hang out with the poor.*/
...
== BYF_Clar @280 /*I completely understand. I thought my father was going to pass out when I told him that I wished to be an actress. The thought of his beloved daughter working side by side with commoners was just unthinkable.*/
...
== BYF_Clar @282 /*And I'm sure the “common folk” appreciate your charity.*/
...
//1st Wilson Banter
CHAIN IF ~InMyArea("WILSON") IfValidForPartyDialog("WILSON") IfValidForPartyDialog("YF_Clara") Global("YF_BClaraWilson","GLOBAL",0)~ THEN BYF_Clar YF_ClaraWilson1
@745 /*Okay, bear, what do I need to do to ride you?*/
== BWILSON @746 /*Rff?*/
== BYF_Clar @747 /*Because <CHARNAME> completely and steadfastly refuses to buy us any horses, that's why!*/
== BWILSON @748 /*Snuffle. Growl. Roar.*/
DO ~SetGlobal("YF_BClaraWilson","GLOBAL",1)~
== BYF_Clar @749 /*Well of course *you* can't ride a horse, but the rest of us could! I should be riding one horse with a second one carrying my bags and a third one as a spare.*/
== BWILSON @750 /*Growl, rff?*/
== BYF_Clar @751 /*Yes, the horses could carry your bags too. No one should have to carry anything.*/
== BWILSON @752 /*Snuffle, roar?*/
== BYF_Clar @753 /*Yes, the horses would be carrying stuff.*/
== BWILSON @754 /*Growl. Snort!*/
== BYF_Clar @755 /*Okay, fine, horses count as *someone* I suppose. All the horses would carry bags, except for the ones we're riding.*/
== BWILSON @756 /*Snuffle, growl. Whine?*/
== BYF_Clar @757 /*Yes, you could eat your horse since you couldn't ride it.*/
= @758 /*But this is all hypothetical since <CHARNAME> refuses to allow any of us to ride horses!*/
== BWILSON @759 /*Snuffle, snuffle... rff?*/
== BYF_Clar @760 /**sigh* Yes, maybe <CHARNAME> would allow you to eat a horse even if the rest of us can't ride them. You'll have to ask <PRO_HIMHER> about that.*/
EXIT

//1st Jaheira banter - she talks first
CHAIN IF ~IfValidForPartyDialog("Jaheira") IfValidForPartyDialog("YF_Clara") InMyArea("YF_Clara") Global("BYF_clarjaheira","GLOBAL",0)~ THEN BJAHEIR YF_clarjaheiraBanter1
@651 /*Clara, why are you here? What are you after?*/
DO ~SetGlobal("BYF_clarjaheira","GLOBAL",1)~
== BYF_Clar @652 /*Seriously? Well, I want to stay alive.*/
== BJAHEIR @653 /*Then you have chosen your companions poorly. We live in constant danger.*/
== BYF_Clar @654 /*I didn't choose you, you brought me back to life after Hexxat killed me.*/
...
== BYF_Clar @657 /*Yeah, I heard about your husband. So why are you here?*/
...
== BYF_Clar @664 /*Thanks, Jaheira.*/
EXIT

//1st HaerDalis Banter - he talks first
CHAIN IF WEIGHT #3 ~InParty("YF_Clara") InMyArea("YF_Clara") IfValidForPartyDialog("HaerDalis") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAHD","GLOBAL",0)~ THEN BHAERDA YF_ClaraHaerDalis1
...
DO ~SetGlobal("YF_BCLARAHD","GLOBAL",1)~
== BYF_Clar @258 /*Thank you for the compliment, but I'm afraid you're wrong about that. Why do you think I was working for the Shadow Thieves?*/
...
== BYF_Clar @263 /*I appreciate the offer. But I no longer want to be an actress. I have my sights set higher now.*/
== BHAERDA @264 /*Ahh, that is a pity. I shall content myself with watching the many masks you show the world.*/
EXIT

//1st Mazzy Banter
CHAIN IF ~InParty("Mazzy") InMyArea("Mazzy") IfValidForPartyDialog("Mazzy") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAMAZ","GLOBAL",0)~ THEN BYF_Clar YF_ClaraMazzy1
@18 /*Mazzy, could you help me with something?*/
DO ~SetGlobal("YF_BCLARAMAZ","GLOBAL",1)~
== BMAZZY @19 /*Of course, Clara, what is it?*/
== BYF_Clar @20 /*We're always fighting things and it's dangerous and I don't want to die!*/
== BMAZZY @21 /*A valid fear. I recommend that you stay back out of the fray and shoot our enemies with arrows.*/
== BYF_Clar @22 /*But when I do that, I always worry about hitting the wrong person.*/
...
//1st Aerie Banter
CHAIN IF ~InParty("Aerie") InMyArea("Aerie") IfValidForPartyDialog("Aerie") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAAERIE","GLOBAL",0)~ THEN BYF_Clar YF_ClaraAerie1
@409 /*Hey, Aerie. Who's this Chiktikka Fastpaws that you're always mentioning? Are they some kind of avariel god?*/
DO ~SetGlobal("YF_BCLARAAERIE","GLOBAL",1)~
...
== BYF_Clar @411 /*You can do that? I always figured that I had to stick with human deities. If I'd known I could worship anyone, I would have spread my prayers around. It never hurts to have a few more gods and goddesses on my side.*/
...
== BYF_Clar @414 /*Seriously? You're a powerful mage and cleric with dozens of spells at your fingertips, and the patron that you call upon is some talking animal?*/
= @415 /*No offense, Aerie, but you're actually kinda weird.*/
EXIT

//1st Rasaad Banter
CHAIN IF ~InParty("RASAAD") InMyArea("RASAAD") IfValidForPartyDialog("RASAAD") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARARAS","GLOBAL",0)~ THEN BYF_Clar YF_ClaraRasaad1
@416 /*You know, Rasaad, you're really very flexible.*/
DO ~SetGlobal("YF_BCLARARAS","GLOBAL",1)~
== BRASAAD @417 /*Clara? How long have you been standing there?*/
== BYF_Clar @418 /*Not too long. But don't stop on my account. I'm quite enjoying the view. Do you always practice without your tunic?*/
...
== BYF_Clar @420 /*Mmm, yes, that is quite sensible. All that sweaty skin... Tell, me, are all Sun Soul Monks so... supple? Or do you have special skills?*/
...
== BYF_Clar @422 /*Actually, I think I would enjoy that.*/
= @423 /*Dazzle me with excellence.... and leave the tunic off.*/
EXIT

//1st Minsc Banter
CHAIN IF ~InParty("Minsc") InMyArea("Minsc") IfValidForPartyDialog("Minsc") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAMINSC","GLOBAL",0)~ THEN BYF_Clar YF_ClaraMinsc1
@424 /*So, Minsc, this pet hamster of yours – is he very valuable?*/
DO ~SetGlobal("YF_BCLARAMINSC","GLOBAL",1)~
...
== BYF_Clar @426 /*Oookkaayyy then. Forget I said anything.*/
...
== BYF_Clar @429 /*And that's good, right?*/
== BMINSC @430 /*Of course! It is the goodest!*/
= @431 /**squeak. squeak.* Yes. Boo agrees. And Boo is the smart one.*/
== BYF_Clar @432 /*Yes, I think he is.*/
EXIT

//1st Keldorn Banter
CHAIN IF ~InParty("Keldorn") InMyArea("Keldorn") IfValidForPartyDialog("Keldorn") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAKELD","GLOBAL",0)~ THEN BYF_Clar YF_ClaraKeldorn1
...
DO ~SetGlobal("YF_BCLARAKELD","GLOBAL",1)~
== BKELDOR @324 /*I am flattered at the comparison. Where is your father now?*/
== BYF_Clar @325 /*Dead. He was slain most cruelly by men with evil in their hearts. My father and my mother and most of my near kin.*/
== BKELDOR @326 /*That is tragic news indeed. I hope our similarities do not cause you pain.*/
== BYF_Clar @327 /*No, Sir Keldorn, do not worry. My father died defending me, that is the reason I still live, and so your presence is a comfort which reminds me I was loved. I feel safe around you, safe enough to think on better days.*/
...
//1st Viconia Banter
CHAIN IF ~InParty("Viconia") InMyArea("Viconia") IfValidForPartyDialog("Viconia") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAVIC","GLOBAL",0)~ THEN BYF_Clar YF_ClaraViconia1
@25 /*Viconia, you're so beautiful...*/
DO ~SetGlobal("YF_BCLARAVIC","GLOBAL",1)~
== BVICONI @26 /*That is the first true thing you've said in days.*/
== BYF_Clar @27 /*I... I don't understand.*/
...
== BYF_Clar @31 /*Well, I always loved acting... pretending to be something other than I was. I wanted to be a great theater actor and travel the world from stage to stage.*/
== BVICONI @32 /*So your entire life is a lie created to suit you?*/
== BYF_Clar @33 /*All life is a stage, Viconia. We are all actors.*/
...
== BYF_Clar @35 /*Poison. Teach me to make poison. You're a drow and everyone knows that the drow have the best poisons.*/
...
== BYF_Clar @38 /*So will you teach me to make poison or not?*/
== BVICONI @39 /*Have you ever seen me make poison? How do you know I even can?*/
== BYF_Clar @40 /*Yes or no?*/
== BVICONI @41 /*Yes, but you will owe me... something.*/
== BYF_Clar @42 /*Fine, fine. Whatever you want. What do we do?*/
...
//1st Dorn Banter
CHAIN IF ~InParty("DORN") InMyArea("DORN") IfValidForPartyDialog("DORN") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARADORN","GLOBAL",0)~ THEN BYF_Clar YF_clardorn1
@44 /*Dorn, is this what you all do? Seek out death over and over again?*/
DO ~SetGlobal("YF_BCLARADORN","GLOBAL",1)~
...
== BYF_Clar @46 /*I'm not scared of the boring stuff. But the rest... You'll protect me though, right? You're so strong and fierce. I could use someone like you.*/
== BDORN @47 /*Look, girl. Protecting isn't really what I do. Just stay out of my way and I probably won't kill you by accident.*/
== BYF_Clar @48 /*Please? I bet you would be an amazing protector if you only had someone you cared for.*/
...
== BYF_Clar @54 /*Fine! But since my mom didn't bed an orc, I'm a skinny, fragile human and I need your help. To... to become stronger.*/
== BDORN @55 /*That's more like it. How can I help?*/
== BYF_Clar @56 /*Poison! You coat your weapons in poison. Teach me how.*/
...
CHAIN IF ~InParty("Korgan") InMyArea("Korgan") IfValidForPartyDialog("Korgan") IfValidForPartyDialog("YF_Clara") !AreaType(DUNGEON) Global("YF_BCLARAKOR","GLOBAL",0)~ THEN BYF_Clar YF_ClaraKorgan1
@58 /*Korgan, can you please help me with something?*/
DO ~SetGlobal("YF_BCLARAKOR","GLOBAL",1)~
...
== BYF_Clar @62 /*I am not a princess!*/
...
== BYF_Clar @66 /*Let's try this again.*/
...
== BYF_Clar @69 /*I need to be tough like you. I keep worrying that I'm going to die out here.*/
...
== BYF_Clar @73 /*Okay... but what makes dwarves so tough? Perhaps I could copy you and benefit.*/
== BKORGAN @74 /*Dwarves dig! Ye wan' t' be tough as a dwarf, girl, ye must dig!*/
== BYF_Clar @75 /*Dig what? A mine?*/
== BKORGAN @76 /*Graves!*/
...
== BYF_Clar @78 /*Like... robbers who attack us?*/
...
== BYF_Clar @81 /*And... and this will make me tougher?*/
...
//1st Yoshimo Banter
CHAIN IF WEIGHT #2 ~InMyArea("YF_Clara") InParty("Yoshimo") IfValidForPartyDialog("Yoshimo") InParty("YF_Clara") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAYOSH","GLOBAL",0)~ THEN BYOSHIM YF_ClaraYosh1
...
== BYF_Clar @220 /*What is a geisha? Is it like a courtesan.*/
...
== BYF_Clar @222 /*I like the sound of that. Can you teach me?*/
...
== BYF_Clar @224 /*That would be wonderful. Yes! Teach me!*/
...
DO ~ApplySpellRES("YF_STRAP","YF_Clara") SetGlobal("YF_BCLARAYOSH","GLOBAL",1)~
EXIT

//1st Edwin Banter - he talks first, male no CN romance
CHAIN IF WEIGHT #2 ~InParty("YF_Clara") IfValidForPartyDialog("Edwin") Gender("Edwin",MALE) InMyArea("YF_Clara") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAEDWIN","GLOBAL",0) !Global("EdwinRomanceActive","GLOBAL",1) !Global("EdwinRomanceActive","GLOBAL",2)~ THEN BEDWIN YF_ClaraEdwin1
@265 /*Clara! You are pretty enough. You will warm my bed tonight.*/
DO ~SetGlobal("YF_BCLARAEDWIN","GLOBAL",1)~
== BYF_Clar @266 /*No. Why would I do that?*/
...
== BYF_Clar @269 /*That's nice. You may be a great wizard, but are you a rich merchant who lives in luxury? Or perhaps a noble lord who would raise my circumstances? You're not even a skilled mercenary who could save me in a fight.*/
= @270 /*What would I get out of this but disappointment? You are far too arrogant to be that great in bed.*/
== BYF_Clar IF ~Global("YF_AnomenClaraRomance","GLOBAL",1)~ THEN @271 /*Besides, I've got something good going on with Anomen. If I play this right, I should get a title for my troubles and I think he's much cuter than you are anyway.*/
== BYF_Clar IF ~OR(2) Global("YF_ClaraAndCor","GLOBAL",1) Global("YF_AnomenClaraRomance","GLOBAL",2)~ THEN @272 /*Besides, in case you haven't noticed, I'm already married. Why would I risk my position for one so-so night with you?*/
== BEDWIN @273 /*But... But... I am Edwin Odesseiron!*/
== BYF_Clar @274 /*And Edwin Odesseiron will be sleeping by himself. I'm sure your ego will keep you plenty warm throughout the night.*/
== BEDWIN @275 /*(This insult cannot be borne. I must find a way to have her.)*/
EXIT

//1st Cernd Banter - must have started quest
CHAIN IF ~InParty("Cernd") InMyArea("Cernd") IfValidForPartyDialog("Cernd") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARACERND","GLOBAL",0) GlobalGT("CerndPlot","GLOBAL",0)~ THEN BYF_Clar YF_ClaraCernd1
@533 /*So you left your wife for love of nature? Are you just into trees that much?*/
DO ~SetGlobal("YF_BCLARACERND","GLOBAL",1)~
== BCERND @534 /*It wasn't like that. I had a calling and she said she understood.*/
== BYF_Clar @535 /*Uh-huh, I'm sure she did. She probably got tired of you sneaking out to go “commune” with nature. Isn't that what you druids do?*/
== BCERND @536 /*Of course not! We speak with nature so that we may guard the balance. That is all.*/
== BYF_Clar @537 /*Really? You mean the rustle of spring leaves doesn't make you tingle? You don't find yourself lusting after the rough touch of bark?*/
== BCERND @538 /*Enough! I will not listen to your insults any longer.*/
== BYF_Clar @539 /*Hah. This druid has a temper.*/
EXIT

//1st Anomen Banter - Clara married Cor
CHAIN IF ~InParty("Anomen") InMyArea("Anomen") IfValidForPartyDialog("Anomen") IfValidForPartyDialog("YF_Clara") Global("YF_LadyDelryn","GLOBAL",1) Global("YF_BCLARACORBURN","GLOBAL",0)~ THEN BYF_Clar YF_ClaraAnomenBurn
@558 /*Come here, Anomen. Hold my pack for me.*/
DO ~SetGlobal("YF_BCLARACORBURN","GLOBAL",1) ChangeStat("YF_Clara",CHR,1,ADD)~
== BANOMEN @559 /*I am not your beast of burden, Clara.*/
== BYF_Clar @560 /*That's Lady Mother to you. Is it not your duty to obey your parents in all things?*/
...
== BYF_Clar @565 /*Oh that's right, you are no longer a Delryn.*/
...
CHAIN IF WEIGHT #-1 ~InParty("YF_Clara") InMyArea("YF_Clara") IfValidForPartyDialog("Imoen2") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAIMOEN","GLOBAL",0)~ THEN BIMOEN2 YF_ClaraImoen1
@568 /*So you're a thief and a conman, huh?*/
DO ~SetGlobal("YF_BCLARAIMOEN","GLOBAL",1) ApplySpellRES("YF_PICKP","YF_Clara")~
== BYF_Clar @569 /*I am NOT a conman.*/
== BIMOEN2 @570 /*Conwoman, sorry.*/
== BYF_Clar @571 /*I prefer to think of myself as an actress...*/
== BIMOEN2 @572 /*Don't we all? I don't know anything about conning, but before studying magic, I became a pretty good thief.*/
== BYF_Clar @573 /*Really? Could you offer some pointers?*/
== BIMOEN2 @574 /*Sure, if you tell me a story.*/
== BYF_Clar @575 /*Does it need to be true? That limits my options.*/
== BIMOEN2 @576 /*Who knows if any stories are true? Just make it fun though.*/
== BYF_Clar @577 /*Very well.*/
== BIMOEN2 @578 /*And so Clara began telling Imoen an amazing story...*/
== BYF_Clar @579 /*Are you narrating the story of me telling you a story?*/
== BIMOEN2 @580 /*Yes, but don't let that distract you.*/
== BYF_Clar @581 /*All right. I'll do my best to blow your mind.*/
EXIT

//1st Neera Banter - Neera talks first
CHAIN IF ~InParty("YF_Clara") InMyArea("YF_Clara") IfValidForPartyDialog("NEERA") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARANEERA","GLOBAL",0)~ THEN BNEERA YF_ClaraNeera1
@688 /*I like how you can just vanish whenever you want. Most people have to use potions.*/
DO ~SetGlobal("YF_BCLARANEERA","GLOBAL",1)~
== BYF_Clar @689 /*Or spells. We could avoid conflict entirely if the rest of you could just stay hidden too.*/
...
== BYF_Clar @693 /*I'll keep my eyes out.*/
...
CHAIN IF ~InParty("Valygar") InMyArea("Valygar") IfValidForPartyDialog("Valygar") IfValidForPartyDialog("YF_Clara") AreaType(FOREST) Global("YF_BCLARAVALYG","GLOBAL",1)~ THEN BYF_Clar YF_ClaraValygar2
@351 /**whisper* Almost there. Just a little more.*/
== BVALYGA @352 /*I can hear you, Clara.*/
== BYF_Clar @353 /*Darn it! I almost had you that time.*/
...
== BYF_Clar @355 /*I don't think so. I like the city far too much for that. I would get too lonely out here by myself.*/
...
== BYF_Clar @357 /*You shouldn't talk like that, you know. I don't think you're really cursed. Just because the rest of your family made some bad decisions doesn't mean that you're an awful guy.*/
...
DO ~ApplySpellRES("YF_HIDE","YF_Clara") ApplySpellRES("YF_MOVE","YF_Clara") SetGlobal("YF_BCLARAVALYG","GLOBAL",2)~
...
//2nd Jan Banter
CHAIN IF ~InParty("Jan") InMyArea("Jan") IfValidForPartyDialog("Jan") IfValidForPartyDialog("YF_Clara") Global("YF_BClaraJan","GLOBAL",1)~ THEN BYF_Clar YF_clarjan2
...
DO ~ChangeStat("YF_Clara",DEX,1,ADD) SetGlobal("YF_BClaraJan","GLOBAL",2)~
== BJAN @88 /*Excellent, now you are ready!*/
== BYF_Clar @89 /*I am! I am ready! What am I ready for?*/
...
DO ~GiveItemCreate("YF_SCOPE","YF_Clara",0,0,0)~
== BYF_Clar @91 /*You did?! Oh, Jan, they're wonderful!*/
= @92 /*What do they do?*/
...
CHAIN IF ~InParty("Korgan") InMyArea("Korgan") IfValidForPartyDialog("Korgan") IfValidForPartyDialog("YF_Clara") !AreaType(DUNGEON) Global("YF_BCLARAKOR","GLOBAL",1)~ THEN BYF_Clar YF_ClaraKorgan2
@145 /*It's working, Korgan, I do feel stronger.*/
DO ~ChangeStat("YF_Clara",STR,1,ADD) SetGlobal("YF_BCLARAKOR","GLOBAL",2)~
== BKORGAN @146 /*Hah, yer as weak as ever. That last fool almost choked ye to death wit' his bare hands.*/
== BYF_Clar @147 /*He was twice my size and he did not. His guts were falling out. He would have collapsed before I died.*/
...
== BYF_Clar @151 /*So I'm supposed to just go into a bar and pick a fight? I am Caroline Aurora Lucia Rosena Silvershield of Beregost! I have a reputation to uphold.*/
...
== BYF_Clar @154 /*Now you're just making things up. There are no dwarf bars around here.*/
== BKORGAN @155 /*There are dwarf bars everywhere. We will stop by th' next one we're near. Get ye some drink! And a woman!*/
EXIT

//2nd Aerie Banter
CHAIN IF ~InParty("Aerie") InMyArea("Aerie") IfValidForPartyDialog("Aerie") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAAERIE","GLOBAL",1)~ THEN BYF_Clar YF_ClaraAerie2
@507 /*Hey, Aerie, this Chitikka Fastpaws is like super fast, right?*/
DO ~SetGlobal("YF_BCLARAAERIE","GLOBAL",2)~
== BAERIE @508 /*I- I mean, I guess so. That's why I always call on h-him when I'm trying to move quickly.*/
== BYF_Clar @509 /*Right. So if I pray to Chiktikka Fastpaws really, really hard, he'll have to make me faster. That's how it works.*/
== BAERIE @510 /*I d-don't think that's exactly....*/
== BYF_Clar @511 /*Yes, it is. Prayers for blessings. That's the deal. Why would anyone bother to worship a god otherwise?*/
== BAERIE @512 /*Well, s-some of us j-just want to say thank you. And I f-find it comforting to know that s-someone is listening.*/
== BYF_Clar @513 /*Uh-huh, whatever. Let's do this.*/
...
CHAIN IF WEIGHT #-5 ~InParty("Viconia") Detect("Viconia") IfValidForPartyDialog("Viconia") InParty("YF_Clara") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAVIC","GLOBAL",3)~ THEN BYF_Clar YF_ClaraViconia2
@98 /*Okay, so I mix the blue with the green.*/
== BVICONI @99 /*Good. Now... carefully pour that into the pitcher.*/
== BYF_Clar @100 /*Poured. Now what? And why are you farther away?*/
...
== BYF_Clar @103 /*What? How do I stop it? Help me! Please!*/
== BVICONI @104 /*More help? You are a demanding child. Very well, tell me a secret, and tell me the truth.*/
== BYF_Clar @105 /*A secret? What are you talking about?*/
== BVICONI @106 /*A secret is something that no one else knows. Hurry now; you do not have much time.*/
== BYF_Clar @107 /*My father was sewn into a deer skin and hunted down with dogs.*/
== BVICONI @108 /*Many people must know that.*/
== BYF_Clar @109 /*Everyone who knows it is dead. I killed most of them.*/
== BVICONI @110 /*How?*/
== BYF_Clar @111 /*I served them poisoned food and wine.*/
= @112 /*You have your secret. Don't let me die.*/
== BVICONI @113 /*Did you watch them die?*/
== BYF_Clar @114 /*Yes.*/
== BVICONI @115 /*Did anyone else die too?*/
== BYF_Clar @116 /*The entire feast. Sixty-seven people, four cats, and seven dogs.*/
= @117 /*Now please save me...*/
== BVICONI @118 /*You counted the dead?*/
== BYF_Clar @119 /*Before I fled, yes.*/
= @120 /*It hurts so much... I am going to die, aren't I?*/
== BVICONI @121 /*Yes, but don't worry. I keep my promises.*/
DO ~SetGlobal("YF_BCLARAVIC","GLOBAL",4) Kill("YF_Clara")~
= @122 /*<CHARNAME>, it seems our little cut-purse has expired. We should raise her.*/
EXIT

//On Raise
CHAIN IF WEIGHT #-5 ~InParty("Viconia") Detect("Viconia") IfValidForPartyDialog("Viconia") InParty("YF_Clara") IfValidForPartyDialog("YF_Clara") 
	Global("YF_BCLARAVIC","GLOBAL",4)~ THEN BYF_Clar YF_ClaraViconia3
@123 /*You let me die!*/
DO ~SetGlobal("YF_BCLARAVIC","GLOBAL",5)~
== BVICONI @124 /*Cease your mewling. You are alive, aren't you? Did you learn anything?*/
== BYF_Clar @125 /*Yes, but it hurt!*/
...
== BYF_Clar @128 /*I will be careful! I will! Who should I kill first?*/
...
CHAIN IF ~IfValidForPartyDialog("Jaheira") IfValidForPartyDialog("YF_Clara") InMyArea("YF_Clara") Global("BYF_clarjaheira","GLOBAL",1)~ THEN BJAHEIR YF_clarjaheiraBanter2
@665 /*So you want to live. You want security. And clearly you want gold.*/
DO ~ChangeStat("YF_Clara",WIS,1,ADD) SetGlobal("BYF_clarjaheira","GLOBAL",2)~
== BYF_Clar @666 /*Gold buys safety. It buys freedom.*/
...
== BYF_Clar @670 /*Awww, thanks! I think you're a benefit too.*/
...
//Second Dorn Banter
CHAIN IF ~InParty("DORN") InMyArea("DORN") IfValidForPartyDialog("DORN") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARADORN","GLOBAL",1)~ THEN BYF_Clar YF_clardorn2
...
== BYF_Clar @133 /*That's simple enough. Thanks!*/
DO ~SetGlobal("YF_BCLARADORN","GLOBAL",2)~
= @134 /*...*/
= @135 /*Umm, can I ask you a question? You're attracted to me, right?*/
== BDORN @136 /*Very much so.*/
== BYF_Clar @137 /*So why didn't you play along earlier? You could've had me... repeatedly even... but you turned me down flat.*/
...
== BYF_Clar @140 /*Oh. Well... I would've pretended really well. You wouldn't have been disappointed.*/
== BDORN @141 /*Hmpf. I am tired of lies and deception. At least this way, we both know where we stand.*/
== BYF_Clar @142 /*You know what, Dorn? Under your evil-murderer-routine, you're actually a pretty sweet guy.*/
...
== BYF_Clar @144 /*Yeah... but I think you'd feel bad about it.*/
EXIT

//2nd Nalia Banter (SOA version)
CHAIN IF ~InParty("Nalia") InMyArea("Nalia") IfValidForPartyDialog("Nalia") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARANALIA","GLOBAL",1)~ THEN BYF_Clar YF_ClaraNalia2
...
== BYF_Clar @286 /*I wasn't exactly supposed to be playing with the help. But we were the only nobles around for miles and I was bored out of my mind. Sometimes we would travel from our estate into Beregost, but it isn't exactly a bustling metropolis, not like Baldur's Gate.*/
...
DO ~SetGlobal("YF_BCLARANALIA","GLOBAL",2) ChangeStat("YF_Clara",DEX,1,ADD) ChangeStat("Nalia",DEX,1,ADD)~
...
== BYF_Clar @290 /*So why don't we go dancing?*/
== BNALIA @291 /*Can we do that? There are no balls this time of year.*/
== BYF_Clar @292 /*Not a ball, silly. I've spent a lot of time among the common folk since leaving Beregost and I know some places in Athkatla where we could dance the whole night through. They even play a proper waltz every now and then.*/
...
== BYF_Clar @296 /*Of course, what are friends for? We'll practice all the latest steps and then we'll go out on the town.*/
EXIT

//2nd Yoshimo Banter
CHAIN IF ~InMyArea("Yoshimo") IfValidForPartyDialog("Yoshimo") InParty("Yoshimo") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAYOSH","GLOBAL",1)~ THEN BYF_Clar YF_ClaraYosh2
@226 /*Hyaa! Hyaa!*/
= @227 /*How was that?*/
DO ~ApplySpellRES("YF_KATA","YF_Clara") SetGlobal("YF_BCLARAYOSH","GLOBAL",2)~
...
== BYF_Clar @230 /*Your homeland sounds amazing. I'd like to visit it someday.*/
...
== BYF_Clar @233 /*I would like that.... Hey, Yoshimo?*/
== BYOSHIM @234 /*Yes, my friend?*/
== BYF_Clar @235 /*Why are you being so nice to me? I mean, plenty of men are glad to do me favors, but they usually expect some kind of payment in return. You haven't even tried to get a grope in and I've given you plenty of opportunities.*/
...
== BYF_Clar @239 /*I know that. I did get killed by Hexxat after all. But it seems like everyone wants to kill us and I don't want to die again.*/
...
== BYF_Clar @242 /*I- okay, Yoshimo. Thanks.*/
EXIT

//2nd Edwin Talk - male, no romance
CHAIN IF WEIGHT #2 ~InParty("Edwin") IfValidForPartyDialog("Edwin") Gender("Edwin",MALE) InMyArea("Edwin") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAEDWIN","GLOBAL",1) !Global("EdwinRomanceActive","GLOBAL",1) !Global("EdwinRomanceActive","GLOBAL",2)~ THEN BYF_Clar YF_ClaraEdwin2
...
== BYF_Clar @378 /*Oh, really? Are you suddenly the richest noble in Athkatla?*/
== BEDWIN @379 /*No, of course not! You and your obsession with wealth. So plebeian.*/
== BYF_Clar @380 /*Your pretty sparkles won't feed me when I'm starving. You need good solid coin for that.*/
== BEDWIN @381 /*That is.. (uggh) not the point. And they are more than sparkles.*/
= @382 /*Take this. I will show you.*/
== BYF_Clar @383 /*It's an earring, Edwin. I have seen these before.*/
...
== BYF_Clar @386 /*Really? That is useful.*/
...
== BYF_Clar @388 /*No. I won't.*/
= @389 /*But thank you for the earring. At least I won't have to put up with your staring anymore.*/
DO ~ApplySpell("YF_Clara",WIZARD_SHADOW_DOOR) SetGlobal("YF_BCLARAEDWIN","GLOBAL",2)~
...
// 检查 Clara (脚本名为 YF_Clara) 是否也处于可以进行队伍对话的有效状态。
// 检查当前区域*不*是 "AR4500"。
// 这可能是为了避免在某个特定区域（例如战斗区域或剧情区域）触发此对话。
// 检查全局变量 "YF_BCLARAMAZ" 是否等于 1。
// 这个变量是控制这个特定对话链触发顺序或条件的标志。
// 值为 1 表示第一次互动已发生或满足了触发第二次互动的前置条件。
CHAIN IF ~InParty("Mazzy") InMyArea("Mazzy") IfValidForPartyDialog("Mazzy") IfValidForPartyDialog("YF_Clara") !AreaCheck("AR4500") Global("YF_BCLARAMAZ","GLOBAL",1)~ THEN BYF_Clar YF_ClaraMazzy2
// 指定对话发起者为 BYF_Clar（即 Clara 的对话文件），并指向对话状态 YF_ClaraMazzy2。
...
// 对 Clara (脚本名 "YF_Clara") 施放一个名为 "YF_SBOW" 的法术。
// 根据文件树和之前的分析，YF_SBOW.SPL 可能是一个与 Clara 的弓术技能或特殊能力相关的法术。
// 将全局变量 "YF_BCLARAMAZ" 的值设置为 2。
// 这会更新状态，防止这个对话链被重复触发，或者为后续可能的第三次互动做准备。
DO ~ApplySpellRES("YF_SBOW","YF_Clara") SetGlobal("YF_BCLARAMAZ","GLOBAL",2)~
...
CHAIN IF ~InParty("YF_Clara") InMyArea("YF_Clara") IfValidForPartyDialog("NEERA") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARANEERA","GLOBAL",1)~ THEN BNEERA YF_ClaraNeera2
...
== BYF_Clar @696 /*Oh just a special project of mine. I have a lot of other interests, you know...*/
== BNEERA @698 /*Nope, I don't know. That's why I'm asking.*/
== BYF_Clar @699 /*Okay, so I found this mage, a lecherous old goat with no friends. Classic wizard.*/
...
== BYF_Clar @703 /*You can't! That's the beauty of it. He also wanted other weird things like dryad lips, the left kidney of a man killed by his brother, and then a bunch of really sexual stuff that I don't want to repeat.*/
...
== BYF_Clar @706 /*Long story short, I pilfered as much of his stuff as I could.*/
== BNEERA @708 /*How'd you escape?*/
== BYF_Clar @709 /*Out the front door! He expects me to return soon with a shipment of rare components from my master and my "services" thrown in as a bonus.*/
== BNEERA @710 /*Ewwww...*/
== BYF_Clar @711 /*Yeah... try not to think about that. The important thing is all the cool things I got, including these Invisibility 10-foot radius scrolls. Here you go.*/
DO ~GiveItemCreate("SCRL1J","NEERA",3,0,0)~
== BNEERA @712 /*Thanks! If there's anything I can do for you in return...*/
== BYF_Clar @713 /*Yes! Read with me. My reading isn't as accomplished as I would like, but you're a mage... so I thought...*/
== BNEERA @714 /*Of course! I have just the book; we'll read it together!*/
DO ~SetGlobal("YF_BCLARANEERA","GLOBAL",2) ChangeStat("YF_Clara",INT,1,ADD) ChangeStat("YF_Clara",LORE,10,ADD) ChangeStat("NEERA",LORE,10,ADD)~
...
// 检查 Clara (脚本名为 YF_Clara) 是否也处于可以进行队伍对话的有效状态。
// 检查全局变量 "YF_BCLARAMINSC" 是否等于 1。
// 这个变量很可能是控制这个特定对话链触发顺序或条件的标志。
// 值为 1 表示第一次互动已发生或满足了触发第二次互动的前置条件。	
CHAIN IF ~InParty("Minsc") InMyArea("Minsc") IfValidForPartyDialog("Minsc") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAMINSC","GLOBAL",1)~ THEN BYF_Clar YF_ClaraMinsc2
// 指定对话发起者为 BYF_Clar（即 Clara 的对话文件），并指向对话状态 YF_ClaraMinsc2。
// @433 是 Clara 说的第一句台词的字符串引用 (StrRef)。
@433 /**squeak. squeak. squeak.* Come on, Boo. You want some hard-tack? Or maybe a cracker?*/
DO ~SetGlobal("YF_BCLARAMINSC","GLOBAL",2)~
    // 将全局变量 "YF_BCLARAMINSC" 的值设置为 2。
    // 这会更新状态，防止这个对话链被重复触发，或者为后续可能的第三次互动做准备。
== BMINSC @434 /*What are you doing, Clara?*/
== BYF_Clar @435 /*Uhhh, nothing? Nothing at all. I wasn't trying to steal your hamster. Please don't murder me.*/
...
== BYF_Clar @437 /*Can you really understand him? I've been trying for days but all I hear is squeaking. I thought that maybe I just needed to get closer and listen carefully.*/
...
== BYF_Clar @439 /*Well, that's not me. I'm serious. Teach me how to talk to Boo.*/
...
== BYF_Clar @442 /*I don't... It just sounds the same. Okay, Clara, concentrate...*/
...
== BYF_Clar @446 /*...Ohhh, my brain hurts.*/
== BMINSC @447 /*Yes. You should not think like Minsc too often. Your mind is not so strong.*/
EXIT

//2nd Cernd Banter
CHAIN IF ~InParty("Cernd") InMyArea("Cernd") IfValidForPartyDialog("Cernd") IfValidForPartyDialog("YF_Clara") AreaType(OUTDOOR) Global("YF_BCLARACERND","GLOBAL",1)~ THEN BYF_Clar YF_ClaraCernd2
@540 /*Cernd, what kind of tree is that?*/
DO ~SetGlobal("YF_BCLARACERND","GLOBAL",2)~
== BCERND @541 /*Oh, it's a-*/
== BYF_Clar @542 /*Cernd, is that a sparrow over there?*/
== BCERND @543 /*No, that's-*/
== BYF_Clar @544 /*Cernd, will you turn into a werewolf?*/
== BCERND @545 /*That isn't-*/
== BYF_Clar @546 /*Cernd, can I-*/
...
== BYF_Clar @548 /*Oohh, scary. Is the big bad wolf having a rough day? I thought druids were supposed to be calm no matter what.*/
== BCERND @549 /*That is the goal. But you could try the patience of a saint. Tell me, what will it take for you to be SILENT?*/
== BYF_Clar @550 /*Hmm, I like money. More gold is always good.*/
== BCERND @551 /*I am a druid, Clara. I live off the bounty of nature, not some secret stash of coin.*/
== BYF_Clar @552 /**shrug* Power then. Whatever your grand philosophy, money and power are what makes the world go round.*/
...
== BYF_Clar @555 /*Done and done. Lay your magic on me.*/
...
//2nd Keldorn Banter
CHAIN IF ~InParty("Keldorn") InMyArea("Keldorn") IfValidForPartyDialog("Keldorn") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAKELD","GLOBAL",1)~ THEN BYF_Clar YF_ClaraKeldorn2
@368 /*You are a great seeker of truth, Sir Keldorn. Do all paladins share your ability to see the true nature of their foes?*/
DO ~SetGlobal("YF_BCLARAKELD","GLOBAL",2)~
...
== BYF_Clar @371 /*Really? But then, how can we trust anyone? That's terrible!*/
...
== BYF_Clar @374 /*That is a relief. I am so glad to know that I can trust you to protect us against evils of all kinds. (Do not laugh. You believe that. You believe it honestly.)*/
EXIT

//2nd HaerDalis Banter
CHAIN IF ~InParty("HaerDalis") InMyArea("HaerDalis") IfValidForPartyDialog("HaerDalis") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAHD","GLOBAL",1)~ THEN BYF_Clar YF_ClaraHaerDalis2
@329 /*Haer'Dalis, can I ask you a question?*/
DO ~SetGlobal("YF_BCLARAHD","GLOBAL",2)~
...
== BYF_Clar @331 /*How do actors manage all those quick changes during a performance? Are they just really stealthy or is there some trick to it?*/
== BHAERDA @332 /*Not the question I expected, my silent feline. I thought your heart no longer yearned to walk the stage?*/
== BYF_Clar @333 /*That doesn't mean I'm not still curious. The first time I saw a play, I thought that it was magic when the plain old crone became a princess right before my eyes. But when I asked my father, he said that the performer was simply wearing a second costume underneath and she removed the first too fast for us to see.*/
...
== BYF_Clar @337 /*Really? Isn't that a little wasteful?*/
...
== BYF_Clar @341 /*That was fantastic!*/
...
CHAIN IF ~InMyArea("YF_Clara") IfValidForPartyDialog("WILSON") IfValidForPartyDialog("YF_Clara") Global("YF_BClaraWilson","GLOBAL",1)~ THEN BWILSON YF_ClaraWilson2
@761 /*Sniff sniff.*/
DO ~SetGlobal("YF_BClaraWilson","GLOBAL",2)~
== BYF_Clar @762 /*Thanks, Wilson, though I still want to ride you.*/
DO ~ChangeStat("YF_Clara",CON,1,ADD)~
== BWILSON @763 /*Growl!*/
== BYF_Clar @764 /*Yes, I know that would be unfair.*/
== BWILSON @765 /*Roar!*/
== BYF_Clar @766 /*Yes, I realize that you're not a horse!*/
= @767 /*But we'd be so great together! You mauling people... me shooting others...*/
== BWILSON @768 /*Moan. Whine...*/
== BYF_Clar @769 /*Really? But you're so good at it.*/
= @770 /*I guess it's a good thing you don't like hurting people.*/
== BWILSON @771 /*Snuffle... Roar!*/
== BYF_Clar @772 /*Well of course you would. Everyone likes killing people if they're allowed to eat them.*/
== BWILSON @773 /*Growl. Growl... Sniff.*/
== BYF_Clar @774 /*It's not just you. <CHARNAME> doesn't let me eat the people I kill either.*/
= @775 /*They'd probably taste awful though. We're better off eating deer.*/
EXIT

//2nd Imoen Banter - she talks first
CHAIN IF WEIGHT #1 ~InParty("YF_Clara") InMyArea("YF_Clara") IfValidForPartyDialog("Imoen2") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAIMOEN","GLOBAL",1)~ THEN BIMOEN2 YF_ClaraImoen2
@582 /*Do you have time for a story?*/
== BYF_Clar @583 /*Once upon a time there was a little girl. Her father was rich and her mother was beautiful and she had everything she could want in the world.*/
== BIMOEN2 @584 /*I like it already.*/
== BYF_Clar @585 /*However, an evil baron who lived nearby was jealous of her father and had him murdered. Heartbroken and impoverished, the girl and her mother suffered on whatever meager scraps they could find.*/
== BIMOEN2 @586 /*But it all turns out okay, right?*/
== BYF_Clar @587 /*Starving and homeless, the mother took sick and died and the girl went on alone.*/
== BIMOEN2 @588 /*And now it gets better?*/
== BYF_Clar @589 /*Having nowhere else to turn, the girl took a job in the estate of the evil baron who had killed her father.*/
...
== BYF_Clar @592 /*But she never lost the hope that some day her life would improve.*/
...
== BYF_Clar @596 /*Nothing lasts forever, but that is the end of this story. Now tell me more about traps.*/
DO ~ChangeStat("YF_Clara",TRAPS,20,ADD) SetGlobal("YF_BCLARAIMOEN","GLOBAL",2)~
== BIMOEN2 @597 /*Oh... fine. But after that I want another one.*/
EXIT

//2nd Rasaad Banter - he talks first
CHAIN IF WEIGHT #1 ~InParty("YF_Clara") InMyArea("YF_Clara") IfValidForPartyDialog("RASAAD") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARARAS","GLOBAL",1)~ THEN BRASAAD YF_ClaraRasaad2
@626 /*Clara, my face is up here.*/
== BYF_Clar @627 /*Whoops, sorry. I got distracted.*/
== BRASAAD @628 /*That seems to happen a lot. I'm not sure you're truly suited for the Sun Soul path.*/
== BYF_Clar @629 /*I don't know what you mean. I've really enjoyed your high kicks and your backbends and ooh, the splits. Those are definitely my favorite.*/
...
== BYF_Clar @631 /*Aww, don't say that. I'm definitely more flexible than I was before.*/
DO ~SetGlobal("YF_BCLARARAS","GLOBAL",2) ChangeStat("YF_Clara",DEX,1,ADD) ChangeStat("RASAAD",DEX,1,ADD)~
...
CHAIN IF WEIGHT #-10 ~InParty("Nalia") InMyArea("Nalia") IfValidForPartyDialog("Nalia") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARANALIA","GLOBAL",4)~ THEN BYF_Clar YF_ClaraNalia3
@297 /*Are you ready, Nalia?*/
DO ~UndoExplore() SetGlobal("YF_BCLARANALIA","GLOBAL",5) ChangeStat("YF_Clara",CON,1,ADD) ChangeStat("Nalia",CON,1,ADD)~
== BNALIA @298 /*Yes, I'm ready. How do I look? I tried to make my dress less fancy so I won't stand out too much.*/
== BYF_Clar @299 /*You look beautiful. That's perfect. Those boys won't know what hit them when we walk through the door. We'll have admirers fighting for the chance to touch our hands.*/
...
== BYF_Clar @302 /*Don't worry. We are headed to a semi-respectable establishment and if anyone tries to push things, well, that's what a dagger is for. Stick with me and you'll be fine.*/
...
== BYF_Clar @306 /*Here, drink this. The purple ones will keep you dancing all night long.*/
= @307 /*Now, come on, I love this song. Hey, fellas, you wanna dance with us?*/
== CRODRU01 IF ~AreaCheck("AR0021") InMyArea("YF_Clara")~ THEN @308 /*We would be delighted. Hello missy, would you care to take my hand?*/
== SBCUST01 IF ~AreaCheck("AR0313") InMyArea("YF_Clara")~ THEN @308 
== MTOWN6 IF ~AreaCheck("AR0406") InMyArea("YF_Clara")~ THEN @308 
== FFCUST04 IF ~OR(2) AreaCheck("AR0509") AreaCheck("AR0522") InMyArea("YF_Clara")~ THEN @308 
== DELTOW01 IF ~AreaCheck("AR0513") InMyArea("YF_Clara")~ THEN @308 
== WCUST03 IF ~AreaCheck("AR0704") InMyArea("YF_Clara")~ THEN @308
== DELTOW03 IF ~AreaCheck("AR0709") InMyArea("YF_Clara")~ THEN @308 
== BNALIA @309 /*Of course, thank you. Though I don't think I know this one.*/
== CRODRU01 IF ~AreaCheck("AR0021") InMyArea("YF_Clara")~ THEN @310 /*Don't worry. I'll take good care of you.*/
== SBCUST01 IF ~AreaCheck("AR0313") InMyArea("YF_Clara")~ THEN @310
== MTOWN6 IF ~AreaCheck("AR0406") InMyArea("YF_Clara")~ THEN @310
== FFCUST04 IF ~OR(2) AreaCheck("AR0509") AreaCheck("AR0522") InMyArea("YF_Clara")~ THEN @310
== DELTOW01 IF ~AreaCheck("AR0513") InMyArea("YF_Clara")~ THEN @310
== WCUST03 IF ~AreaCheck("AR0704") InMyArea("YF_Clara")~ THEN @310
== DELTOW03 IF ~AreaCheck("AR0709") InMyArea("YF_Clara")~ THEN @310
== CROWEN01 IF ~AreaCheck("AR0021") InMyArea("YF_Clara")~ THEN @311 /*"Oh when I was a younger lass,
                  Or so my mother told me,
                  That if I tried to kiss a boy
                 My lips would grow all moldy..."*/
== SBWENCH IF ~AreaCheck("AR0313") InMyArea("YF_Clara")~ THEN @311
== WENCH1 IF ~AreaCheck("AR0406") InMyArea("YF_Clara")~ THEN @311
== FFCUST06 IF ~OR(2) AreaCheck("AR0509") AreaCheck("AR0522") InMyArea("YF_Clara")~ THEN @311
== BWENCH IF ~AreaCheck("AR0513") InMyArea("YF_Clara")~ THEN @311
== WWENCH IF ~AreaCheck("AR0704") InMyArea("YF_Clara")~ THEN @311
== SEVBAR01 IF ~AreaCheck("AR0709") InMyArea("YF_Clara")~ THEN @311
== BNALIA @312 /*Oh, that was fun. I never danced like that back home.*/
== BYF_Clar @313 /*Glad to hear it... Did you lose your partner?*/
== BNALIA @314 /*No. He said I wore him out with that last number. But I think I just confused him when I tried to lead.*/
== BYF_Clar @315 /*Hah! Well, there's plenty more to choose from. Try that sailor over there; he's got good legs – for dancing, of course.*/
= @316 /*And here, a green one, just for luck....*/
DO ~ActionOverride("Nalia",ApplySpellRES("YF_intox","Nalia")~
== CROWEN01 IF ~AreaCheck("AR0021") InMyArea("YF_Clara")~ THEN @317 /*"In Athkatla fair city
                  Where the girls are so pretty
                  That's where I first met
                  My own one true love...."*/
== SBWENCH IF ~AreaCheck("AR0313") InMyArea("YF_Clara")~ THEN @317
== WENCH1  IF ~AreaCheck("AR0406") InMyArea("YF_Clara")~ THEN @317
== FFCUST06 IF ~OR(2) AreaCheck("AR0509") AreaCheck("AR0522") InMyArea("YF_Clara")~ THEN @317
== BWENCH IF ~AreaCheck("AR0513") InMyArea("YF_Clara")~ THEN @317
== WWENCH IF ~AreaCheck("AR0704") InMyArea("YF_Clara")~ THEN @317
== SEVBAR01 IF ~AreaCheck("AR0709") InMyArea("YF_Clara")~ THEN @317
== BNALIA @318 /*...We have to stop. I'm exhausted. Is the room spinning or is it me?*/
== BYF_Clar @319 /*Just you, I'm afraid. You're probably going to hate me in the morning. You weren't supposed to drink quite that many potions.*/
= @320 /*So tell me now, was it worth it?*/
== BNALIA @321 /*It was. Thank you. You're the best friend I've ever had.*/
== BYF_Clar @322 /*I like you too, Nalia. Even if you are a bit naive at times. Come on, back to the inn, and try to walk straight if you can.*/
DO ~Explore() RestParty()~
EXIT

//3rd Dorn Banter - he should start dialogue
CHAIN IF WEIGHT #-10 ~InParty("YF_Clara") InMyArea("YF_Clara") IfValidForPartyDialog("DORN") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARADORN","GLOBAL",3) AreaType(FOREST)~ THEN BDORN YF_clardorn3
@169 /*Most people would let me bathe in peace.*/
DO ~UndoExplore() SetGlobal("YF_BCLARADORN","GLOBAL",4) ChangeStat("YF_Clara",WIS,1,ADD)~
== BYF_Clar @170 /*How did you know I was here?*/
...
== BYF_Clar @173 /*I'm watching you bathe. I like watching strong naked men, though most aren't so suspicious about it.*/
== BDORN @174 /*That is either because they are attractive or because they are fools. I am neither. Leave me be.*/
== BYF_Clar @175 /*You always sell yourself short, Dorn. You are both more attractive and more foolish than you believe.*/
== BDORN @176 /*Hah. My hair... my teeth... my smell... I do not need your lies. Go away.*/
== BYF_Clar @177 /*So you're not human. So what? If I lived with elves, I'd be hideous, but I spend my time in Athkatla among poxy whores and frog-like peasant-women so I look pretty good in comparison.*/
...
== BYF_Clar @181 /*So you came to live with humans where you'd be more accepted? Hah. That's just sad.*/
...
== BYF_Clar @186 /*I'm already gone.*/
= @187 /*You won't see me, but I'll be watching you.*/
DO ~Explore() RestParty()~
EXIT

//3rd Yoshimo Banter
CHAIN IF WEIGHT #-1 ~InMyArea("YF_Clara") InParty("Yoshimo") IfValidForPartyDialog("Yoshimo") InParty("YF_Clara") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAYOSH","GLOBAL",2)~ THEN BYOSHIM YF_ClaraYosh3
@243 /*I can feel your eyes on me, lass. Are there words you wish to say?*/
== BYF_Clar @244 /*You saw me?*/
DO ~ApplySpellRES("YF_BKSTB","YF_Clara") SetGlobal("YF_BCLARAYOSH","GLOBAL",3)~
...
== BYF_Clar @247 /*I know. I have enjoyed your stories and I really do want to visit your homeland in the future; maybe once our quest is done.*/
...
== BYF_Clar @253 /*I believe you do not wish to. However, I have not wanted many things that happened anyway. Some by my own hands.*/
...
CHAIN IF ~IfValidForPartyDialog("Jaheira") IfValidForPartyDialog("YF_Clara") InMyArea("Jaheira") Global("BYF_clarjaheiraSoA","GLOBAL",0)~ THEN BYF_Clar YF_clarjaheiraBanterSoA3
...
DO ~SetGlobal("BYF_clarjaheiraSoA","GLOBAL",1) ChangeStat("YF_Clara",CHR,1,ADD)~
...
== BYF_Clar @685 /*Of course! I'd be honored.*/
EXIT

//3rd Korgan Banter - triggers
CHAIN IF WEIGHT #-10 ~InParty("Korgan") InMyArea("Korgan") IfValidForPartyDialog("Korgan") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAKOR","GLOBAL",4)~ THEN BYF_Clar YF_ClaraKorgan3
@188 /*Ooh, I feel awful. Everything hurts. What happened yesterday?*/
DO ~ChangeStat("YF_Clara",CON,1,ADD) ChangeStat("YF_Clara",STR,1,ADD) SetGlobal("YF_BCLARAKOR","GLOBAL",5)~
== BKORGAN @189 /*Ye kin nae be rememberin' anything? Hah, I should've known dwarf ale would be too much fer ye.*/
== BYF_Clar @190 /*I can drink with the best of them, just give me a minute to remember. You blind-folded me and we went to a bar. I was the only one there who wasn't a dwarf. They all hated me.*/
== BKORGAN @191 /*'course they did. Long-limbs aren't welcome in a dwarf bar. Dwarf bars are fer dwarves!*/
== BYF_Clar @192 /*You brought me the strongest drink I've ever tasted and told me to go pick a fight with a woman at a nearby table who looked particularly unhappy with my presence.*/
...
== BYF_Clar @196 /*I refused so you gave me another mug of that awful brown liquid and then another. And after that it all becomes a little blurry...*/
...
== BYF_Clar @198 /*Okay... I remember that. I puked all over her shoes. Then tried to give her my best shot.*/
...
== BYF_Clar @207 /*Does my face look okay? The rest of me looks... is my bosom fuller?*/
...
== BYF_Clar @210 /*Orgy? I remember ribs shattering and passing out and that's all.*/
...
== BYF_Clar @214 /*So you're saying I was healed tougher for free and I made 6,500 gold pieces? Why did I ever waste my time with human men? 6,500 gold in one night is better than even the richest noble courtesans.*/
...
== BYF_Clar @217 /*Please don't tell anyone.*/
== BKORGAN @218 /*An' reveal the secret of dwarf bars? Never.*/
EXIT

//3rd Jan Banter
CHAIN IF WEIGHT #-3 ~InParty("Jan") InMyArea("Jan") IfValidForPartyDialog("Jan") IfValidForPartyDialog("YF_Clara") Global("YF_BClaraJan","GLOBAL",2)~ THEN BYF_Clar YF_clarjan3
...
DO ~GiveItemCreate("YF_Glove","YF_Clara",0,0,0) SetGlobal("YF_BClaraJan","GLOBAL",3)~
== BYF_Clar @166 /*Ooooh... shiny!*/
== BJAN @167 /*Not just shiny, but useful. Why, with these gloves you could steal the clothes right off a man's back.*/
== BYF_Clar @168 /*Well, it's usually easier to let men take their clothes off voluntarily, but thanks! I'm sure I'll find these useful.*/
EXIT

//3rd Wilson Banter - he talks first
CHAIN IF WEIGHT #1 ~InMyArea("YF_Clara") IfValidForPartyDialog("WILSON") IfValidForPartyDialog("YF_Clara") Global("YF_BClaraWilson","GLOBAL",2)~ THEN BWILSON YF_ClaraWilson3
@776 /*Roar!*/
DO ~SetGlobal("YF_BClaraWilson","GLOBAL",3)~
== BYF_Clar @777 /*Oh come on! There must be something I can give you.*/
= @778 /*I'm so tired of walking...*/
DO ~ChangeStat("YF_Clara",CON,1,ADD)~
== BWILSON @779 /*Sniff, sniff... snuffle...*/
== BYF_Clar @780 /*How could you possibly have everything you want? That seems like a failure of imagination.*/
== BWILSON @781 /*Snuffle: growl, roar, roar... sniff... Roar!*/
== BYF_Clar @782 /*Wow, that is a pretty good list... but I have all of those things too and I still want more.*/
== BWILSON @783 /*Sniff... whine?*/
== BYF_Clar @784 /*Of course it will make me happy! Having more always makes me happy!*/
= @785 /*Okay, fine, it hasn't made me happy yet, but that's just because I don't have enough!*/
== BWILSON @786 /*Growl?*/
== BYF_Clar @787 /*Yes, my logic is perfectly sound!*/
== BWILSON @788 /*Roar!*/
== BYF_Clar @789 /*Oh what do you know? You're just a bear!*/
EXIT

//3rd Aerie Banter
CHAIN IF ~InParty("Aerie") InMyArea("Aerie") IfValidForPartyDialog("Aerie") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAAERIE","GLOBAL",2)~ THEN BYF_Clar YF_ClaraAerie3
@517 /*Well, Chiktikka Fastpaws was a bust. Damn raccoon has a sense of humor.*/
DO ~SetGlobal("YF_BCLARAAERIE","GLOBAL",3)~
= @518 /*Hey, Aerie, who was that other god you mentioned earlier?*/
== BAERIE @519 /*D-Do you mean Baervan Wildwanderer?*/
== BYF_Clar @520 /*Yeah, him. Tell me about him.*/
...
== BYF_Clar @523 /*Yes! I swear they're doing this on purpose. All they talk about is food! Maybe if I pray to Baervan, I can make the things shut up.*/
== BAERIE @524 /*I- I told you, that's n-not how it works. You can't just p-pray when you want things.*/
== BYF_Clar @525 /*Ssshh, I'm communing with your god....*/
...
== BYF_Clar @528 /*Really? Can you like, give me truesight too?*/
...
== BYF_Clar @531 /*What?! Aerie! That wasn't very nice.*/
...
//3rd Neera Banter
CHAIN IF ~InParty("NEERA") InMyArea("NEERA") IfValidForPartyDialog("NEERA") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARANEERA","GLOBAL",2)~ THEN BYF_Clar YF_ClaraNeera3
@716 /*Well, that was an illuminating read. Thanks, Neera!*/
DO ~SetGlobal("YF_BCLARANEERA","GLOBAL",3) ChangeStat("YF_Clara",INT,1,ADD) ChangeStat("YF_Clara",LORE,10,ADD) ChangeStat("NEERA",LORE,10,ADD)~
= @717 /*It's a pity the book ended at "G". I was hoping to find out what this helm was...*/
DO ~GiveItemCreate("HELM02","YF_Clara",0,0,0)~
== BNEERA @718 /*I guess you just need this one! I got it for you, special.*/
== BYF_Clar @719 /*'Magical Items and Their Identifying Properties Volume II: Gauntlets of God-Stalking through Purple Brotherhood Accessories.'*/
= @720 /*Yaay! You'll have to help me though.*/
== BNEERA @721 /*Of course! We can read it together too.*/
EXIT

//3rd Minsc Banter
CHAIN IF ~InParty("Minsc") InMyArea("Minsc") IfValidForPartyDialog("Minsc") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAMINSC","GLOBAL",2)~ THEN BYF_Clar YF_ClaraMinsc3
@448 /**squeak, squeak, squeak!**/
DO ~SetGlobal("YF_BCLARAMINSC","GLOBAL",3)~
...
== BYF_Clar @451 /*Umm, I may regret asking this, but what are the other two?*/
== BMINSC @452 /*Other two what?*/
== BYF_Clar @453 /*Other two skills of Heroing. You said that one was hamster-talking...*/
== BMINSC @454 /*Ahh, the second is not-being-seen-while-moving-ing. You already have that one.*/
= @455 /*And the third is berserkering!*/
== BYF_Clar @456 /*You mean that thing where you go crazy in battle and we all have to stay far away so you don't accidentally kill us?*/
...
//3rd Valygar Banter
CHAIN IF ~InParty("Valygar") InMyArea("Valygar") IfValidForPartyDialog("Valygar") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAVALYG","GLOBAL",2)~ THEN BYF_Clar YF_ClaraValygar3
...
DO ~SetGlobal("YF_BCLARAVALYG","GLOBAL",3)~
...
== BYF_Clar @366 /*That's amazing. There are really herbs that can hide you from a spell?*/
...
CHAIN IF ~InParty("HaerDalis") InMyArea("HaerDalis") IfValidForPartyDialog("HaerDalis") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAHD","GLOBAL",2)~ THEN BYF_Clar YF_ClaraHaerDalis3
...
== BYF_Clar @476 /*Are you sure that we've been fighting the same battles? I mostly just hear screaming and I don't think I could ever use two swords the way you do.*/
= @477 /*How do you not stab yourself by accident?*/
DO ~SetGlobal("YF_BCLARAHD","GLOBAL",3) ApplySpellRES("YF_SSP","YF_Clara")~
...
//3rd Imoen Banter
CHAIN IF WEIGHT #3 ~InParty("YF_Clara") InMyArea("YF_Clara") IfValidForPartyDialog("Imoen2") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAIMOEN","GLOBAL",2)~ THEN BIMOEN2 YF_ClaraImoen3
@598 /*You up for another story, Clara?*/
== BYF_Clar @599 /*Yes. Once upon a time there was a young lady who was a respected servant in the household of an evil baron.*/
...
== BYF_Clar @602 /*Every day while doing her work, the young woman sought and learned skills that might help her in the future.*/
...
== BYF_Clar @606 /*The witch wanted her life and her soul. The young lady said she would not part with those, but perhaps she could offer the lives and souls of others.*/
...
== BYF_Clar @612 /*You are the one who keeps asking for them. I, on the other hand, want to know about locks and how to open them.*/
DO ~ChangeStat("YF_Clara",LOCKPICKING,20,ADD) SetGlobal("YF_BCLARAIMOEN","GLOBAL",3)~
EXIT


//4th Minsc Banter
CHAIN IF ~InParty("Minsc") InMyArea("Minsc") IfValidForPartyDialog("Minsc") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAMINSC","GLOBAL",3)~ THEN BYF_Clar YF_ClaraMinsc4
@461 /*RAAAAAARGH!*/
DO ~SetGlobal("YF_BCLARAMINSC","GLOBAL",4)~
...
== BYF_Clar @464 /*That is so refreshing! I see how one could lose themselves in that. I've spent all my battles until now trying so carefully not to die.*/
== BMINSC @465 /*That is a foolish thing to try. Boo has something to say about that.*/
= @466 /**squeak squeak squeak**/
== BYF_Clar @467 /*"We should smile because death is smiling?" Isn't that kind of morbid?*/
...
== BYF_Clar @469 /*Still morbid... but I think I understand. We're all going to die, so we might as well enjoy ourselves, right?*/
...
CHAIN IF ~InParty("YF_Clara") InMyArea("YF_Clara") IfValidForPartyDialog("NEERA") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARANEERA","GLOBAL",3)~ THEN BNEERA YF_ClaraNeera4
@722 /*Oh Clara, I got it!*/
== BYF_Clar @723 /*'Magical Items and their Identifying Properties Volume III: Purple Brotherhood Armbands through Zyztrax's Left Hand.'*/
= @724 /*Aww, this must be the last one. We'll have to read it slowly.*/
= @725 /*Oh, I got you something too! Here!*/
DO ~GiveItemCreate("MISC1B","NEERA",0,0,0) SetGlobal("YF_BCLARANEERA","GLOBAL",4) SetGlobal("YF_NeeraHasGrimoire","GLOBAL",1) ChangeStat("YF_Clara",INT,1,ADD) ChangeStat("YF_Clara",LORE,10,ADD) ChangeStat("NEERA",LORE,10,ADD) ChangeStat("NEERA",INT,1,ADD)~
== BNEERA @726 /*Is that the Butter Knife of Balduran? That's from the first book!*/
= @727 /*As I remember, it's completely useless...*/
== BYF_Clar @728 /*Well... not USELESS... it CAN spread butter...*/
...
== BYF_Clar @733 /*Nah, the wizard who previously owned it can't use it anymore. He's all...*/
...
== BYF_Clar @737 /*You're welcome! I tried reading it, but couldn't make any sense of the words.*/
...
//4th Imoen Banter
CHAIN IF WEIGHT #1 ~InParty("Imoen2") InMyArea("YF_Clara") IfValidForPartyDialog("Imoen2") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARAIMOEN","GLOBAL",3)~ THEN BIMOEN2 YF_ClaraImoen4
@613 /*Once again, Clara. Story me.*/
== BYF_Clar @614 /**sigh* Once upon a time, there was a young woman in a castle of the dead. She had poisoned the inhabitants during a feast and they perished that night in their own beds.*/
...
== BYF_Clar @622 /*She has to be happy, it's the end of the story. When your story is over, you live happily ever after.*/
== BIMOEN2 @623 /*I don't think life works like that.*/
== BYF_Clar @624 /*Do you know what would make me happy? Figuring out how to make a trap. Something horribly devastating that can trigger when we're far, far away.*/
DO ~SetGlobal("YF_BCLARAIMOEN","GLOBAL",4)~
== BIMOEN2 @625 /*Oh, I have some ideas for that! Sort of a thiefy-magicy combination. You can help!*/
EXIT

//4th Dorn Banter - he talks first
CHAIN IF WEIGHT #1 ~InParty("YF_Clara") InMyArea("YF_Clara") IfValidForPartyDialog("DORN") IfValidForPartyDialog("YF_Clara") Global("YF_BCLARADORN","GLOBAL",4)~ THEN BDORN YF_clardorn4
@634 /*Kryll...*/
== BYF_Clar @635 /*Aww, Dorn, if you keep mumbling another woman's name, I'll think that you don't love me.*/
DO ~ChangeStat("YF_Clara",SAVEVSDEATH,-1,ADD) SetGlobal("YF_BCLARADORN","GLOBAL",5)~
== BDORN @636 /*I did not see you standing there. It seems you have still not learned to mind your own business.*/
== BYF_Clar @637 /*You were lost in thought and said, "Kryll". You say her name when you sleep as well.*/
= @638 /*So who's Kryll?*/
== BDORN @639 /*An answer for an answer. How do you know I say her name in my sleep?*/
== BYF_Clar @640 /*There's a foolish question. Clearly I've been watching you secretly.*/
...
== BYF_Clar IF ~Global("DornRomanceActive","GLOBAL",1)~ THEN @645 /*You seem to be pretty friendly with <CHARNAME>. How do you expect that to end?*/
== BYF_Clar IF ~Global("YF_HDDornRomance","GLOBAL",1)~ THEN @6450 /*You seem pretty friendly with Haer'Dalis. How do you expect that to end?*/
== BDORN IF ~Global("DornRomanceActive","GLOBAL",1)~ THEN @646 /*With my death or <CHARNAME>'s, same as always.*/
== BDORN IF ~Global("YF_HDDornRomance","GLOBAL",1)~ THEN @6460 /*With my death or the tiefling's, same as always.*/
== BYF_Clar IF ~Global("DornRomanceActive","GLOBAL",2)~ THEN @647 /*But you and <CHARNAME> are together and that seems to be going very well.*/
== BYF_Clar IF ~Global("YF_HDDornRomance","GLOBAL",2)~ THEN @6470 /*But you and Haer'Dalis are together and that seems to be going very well... Especially in bed.*/
...
== BDORN IF ~Global("YF_HDDornRomance","GLOBAL",2)~ THEN @6480 /*Things often go well for a time. That does not mean our relationship will not end in bloodshed... even if I might wish otherwise.*/
== BYF_Clar @649 /*You know, Dorn, for a murderous psychopath, you sure are broody and depressing.*/
